  ...
  ///  if (latiStr.find(stop.stop_lat) != std::string::npos && loniStr.find(stop.stop_lon) != std::string::npos) {
   ...
   //  std::cout << "double: " << double << std::endl;
         ...
         if (s < 30) {
              // std::ofstream myfile;
             //  myfile.open ("stoplessthan30.csv");
               myfile << "osm lat" << ","<< "osm lon" << ","<< "gtfs lat" << ","<< "gtfs lon" << "\n";
               myfile << coord.lati << ","<< coord.loni << ","<< stop.stop_lat << ","<< stop.stop_lon << "\n";
               //myfile.close();
               distanceless30++;
               ...
               //std::ofstream myfile2;
              // myfile2.open ("stopmorethan30.csv");
               myfile2 << "osm lat" << ","<< "osm lon" << ","<< "gtfs lat" << ","<< "gtfs lon" << "\n";
               myfile2 << coord.lati << ","<< coord.loni << ","<< stop.stop_lat << ","<< stop.stop_lon << "\n";
              // myfile2.close();
              // int distancemore30++;
