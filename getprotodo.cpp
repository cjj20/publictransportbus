...
if(!msg.ParseFromIstream(&file1)) {
  cout << "failed to parse" << endl;  //or std::cerr << "Failed to parse protobuf message" << std::endl;
  //return false; //seems unnecessary
}

if(msg.ParseFromIstream(&file1)) {
  cout << msg.entity_size() << "parsing message info" << endl;  //or std::cerr << "Failed to parse protobuf message" << std::endl;
...
if(msg3.ParseFromString(binn)) {
  cout << msg.entity_size() << "parsing message string entity size" << endl;  //or std::cerr << "Failed to parse protobuf message" << std::endl;
  cout << msg.DebugString() << endl;
  //return false; //seems unnecessary
}
...
if(alr.ParseFromIstream(&file1)) {
 ...
 //cout <<  ent.alert()   << endl;
 //cout <<  ent.stop()   << endl;
 //cout <<  transit_realtime::FeedMessage::_internal_entity_size()   << endl;
 cout <<  ent.has_alert()   << endl;
 //cout <<  ent.alert()   << endl;
 //cout <<  ent.alert   << endl;
 ...
 //cout <<  transit_realtime.Alert.SeverityLevel.has_severity_level()   << endl;
 //cout <<  transit_realtime.Alert.has_severity_level()   << endl;
